...
public class TimelineVolumeReport extends TimelineReport {
	...
	public DefaultCategoryDataset constructDefaultCategoryDataset(String categoryLabel) {
		if (this.getResult() != null) {
			...
			for (TimelineReportRegister<?> register : this.getResult()) {
				...
				auxDate = c.getTime();
				ret.addValue((Number) register.getValue(), categoryLabel, auxDate);
			}
			return ret;
		}
		return null;
	...
	public XYDataset constructXYDataset(String categoryLabel) {
		if (this.getResult() != null) {
			TimeSeries series = new TimeSeries("Number of tweets");
	...
	@Override
	public IntervalXYDataset constructIntervalXYDataset(String categoryLabel) {
		if (this.getResult() != null) {
			TimeSeries series = new TimeSeries("Number of tweets");
