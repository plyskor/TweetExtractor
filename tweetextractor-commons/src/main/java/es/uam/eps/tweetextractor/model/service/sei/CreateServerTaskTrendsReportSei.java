...
public interface CreateServerTaskTrendsReportSei {
	public CreateServerTaskTrendsReportResponse createServerTaskTrendsReport(int userId,AnalyticsReportTypes reportType,int limit,List<Integer>extractions,List<String> filter);
}
