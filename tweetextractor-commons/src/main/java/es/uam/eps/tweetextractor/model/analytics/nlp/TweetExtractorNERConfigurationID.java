 ...
 */
@Embeddable
public class TweetExtractorNERConfigurationID implements Serializable{
	@Transient
	@XmlTransient
	private static final long serialVersionUID = -9219807587481159666L;
	 ...
	 * 
	 */
	public TweetExtractorNERConfigurationID() {
		super();
	}
	 ...
	 * @param name
	 */
	public TweetExtractorNERConfigurationID(AvailableTwitterLanguage language, User user, String name) {
		super();
