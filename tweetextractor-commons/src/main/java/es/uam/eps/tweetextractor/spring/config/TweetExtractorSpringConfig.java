...
@ComponentScans(value = { 
      @ComponentScan("es.uam.eps.tweetextractor.dao"),
...
public class TweetExtractorSpringConfig {
   ...
   public DataSource getDataSource() {
      ...
      dataSource.setUrl("jdbc:postgresql://db.preciapps.com/te_dev01?currentSchema=te_dev01&ssl=true&sslfactory=org.postgresql.ssl.NonValidatingFactory");
      dataSource.setUsername("te_dev01_update");
      dataSource.setPassword("te_dev01_update");
      return dataSource;
   }
   ...
   public LocalSessionFactoryBean getSessionFactory() {
      ...
      factoryBean.setAnnotatedClasses(User.class,Extraction.class,Tweet.class,GeoLocation.class,ServerTask.class,Credentials.class,Filter.class,FilterContains.class,FilterContainsExact.class,FilterFrom.class, FilterTo.class, FilterHashtag.class, FilterList.class, FilterMention.class, FilterNot.class, FilterOr.class, FilterSince.class, FilterUntil.class, FilterUrl.class, ExtractionServerTask.class, ServerTaskUpdateExtractionIndef.class);
      return factoryBean;
   }
