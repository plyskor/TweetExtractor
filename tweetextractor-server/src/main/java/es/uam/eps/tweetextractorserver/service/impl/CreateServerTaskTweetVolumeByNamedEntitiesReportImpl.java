...
@Controller
@WebService(endpointInterface = "es.uam.eps.tweetextractor.model.service.sei.CreateServerTaskTweetVolumeByNamedEntitiesReportSei", serviceName = "CreateServerTaskTweetVolumeByNamedEntitiesReport")
public class CreateServerTaskTweetVolumeByNamedEntitiesReportImpl implements CreateServerTaskTweetVolumeByNamedEntitiesReportSei{
	@Resource
	...
	@WebMethod(action = "createServerTaskTweetVolumeByNamedEntitiesReportImpl")
	@Override
	public CreateServerTaskTweetVolumeNLPReportResponse createServerTaskTweetVolumeByNamedEntitiesReport(
		...
		ServerTaskTweetVolumeByNamedEntitiesReport task = new ServerTaskTweetVolumeByNamedEntitiesReport();
		AnalyticsTweetVolumeByNamedEntitiesReport report = new AnalyticsTweetVolumeByNamedEntitiesReport();
		report.setPreferences(config);
		task.setUser(u);
		report.setReportType(AnalyticsReportTypes.TVNE);
		report.setUser(u);
		report.setExtractions(eServ.findListById(extractions));
		task.setTaskType(TaskTypes.TTVNE);
		try {
			stServ.persist(task);
