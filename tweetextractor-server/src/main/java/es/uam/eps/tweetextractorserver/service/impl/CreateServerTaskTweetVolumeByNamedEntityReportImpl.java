 ...
 */
@Controller
@WebService(endpointInterface = "es.uam.eps.tweetextractor.model.service.sei.CreateServerTaskTweetVolumeByNamedEntityReportSei", serviceName = "CreateServerTaskTweetVolumeByNamedEntityReport")
public class CreateServerTaskTweetVolumeByNamedEntityReportImpl
		implements CreateServerTaskTweetVolumeByNamedEntityReportSei {
	@Resource
	...
	@WebMethod(action = "createServerTaskTweetVolumeByNamedEntityReport")
	@Override
	public CreateServerTaskTweetVolumeByNamedEntityReportResponse createServerTaskTweetVolumeByNamedEntityReport(
		...
		CreateServerTaskTweetVolumeByNamedEntityReportResponse reply = new CreateServerTaskTweetVolumeByNamedEntityReportResponse();
		...
		ServerTaskTweetVolumeByNamedEntityReport task = new ServerTaskTweetVolumeByNamedEntityReport();
		...
		task.setTaskType(TaskTypes.TVNE);
		try {
			stServ.persist(task);
